...
| [Etsy SEO Studio](https://github.com/iamfenil/etsy-seo-studio) | Private Cloudflare Workers + D1 app for Etsy listing audits, encrypted OAuth, seller-reviewed drafts and field-scoped updates. Jewelry pricing supports rings, earrings, bracelets and pendants, fixed/multiple carats, side stones, length scaling, and optional separate Diamond Type, Carat Weight and Metal variations with independent Lab Diamond/Moissanite costing. Includes duplicate-aware SKU lookup, visual price comparisons, stock-preserving inventory sync, custom options, and a private approval-gated MCP control plane with stale-state checks, idempotency and read-back verification. Settlement-aware pricing separates platform fees, payment-provider charges and payout FX across Etsy, Shopify and social-sales profiles with net-profit previews. |

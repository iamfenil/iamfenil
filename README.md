...
| Shopify Listing Studio | Private Cloudflare Workers + D1 product and pricing platform for Shopify Admin GraphQL API. Includes exact Etsy price comparison, duplicate-aware SKU lookup, draft-only creation, field-scoped product and variant-price controls, reversible archive, guarded deletion, single-use approvals, atomic claims, stale-state checks, idempotency, and post-write verification through a private MCP control plane |

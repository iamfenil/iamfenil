...
| Etsy Chrome Scraper Extension | Private Chrome MV3 extension for parallel scraping visible Etsy shop, listing, public sold-listing rows, metadata, shipping, media, and review data from a real browser session with JSON/CSV exports, saved history, and fixture-tested extraction |

...
| [Etsy SEO Studio](https://github.com/iamfenil/etsy-seo-studio) | Private Cloudflare Workers + D1 app for Etsy Open API listing operations, jewelry draft creation, and verified updates. It supports optional Moissanite + Lab Diamond buyer variations with separate per-stone metal rates, making charges, percentage hikes, target profits, and full-ladder carat-profit increases that price a fixed higher-carat product correctly without adding a redundant buyer option, plus settlement-aware pricing, duplicate-aware SKU lookup, quantity-safe inventory sync, translations, and an approval-gated MCP control plane with stale-state checks, idempotency, and read-back verification |

...
| Etsy SEO Studio | Private Cloudflare Workers + D1 app for authorized Etsy Open API listing SEO audits, encrypted OAuth token storage, listing sync, scoring, seller-reviewed optimization suggestions, and Jewelry Listing Studio for draft creation, verified price-only updates, and tags-only SEO updates using Ronora pricing logic |
...
| Etsy Search SEO Scraper Extension | Private Chrome MV3 extension for Etsy listing keyword campaigns using product focus, short keyword variants, ranked competitor listings, Bestseller/Etsy Pick/Popular now signals, opportunity scoring, and workbook/JSON/CSV exports |

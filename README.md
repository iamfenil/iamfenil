...
| Etsy Chrome Scraper Extension | Private Chrome MV3 extension for parallel scraping visible Etsy shop, listing, public sold-listing rows, metadata, shipping, media, and review data from a real browser session, now enriched with Etsy Open API verified tags, materials, taxonomy, favorer count, API reviews, media, SEO term summaries, JSON/CSV exports, saved history, and fixture-tested extraction |

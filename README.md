...
| Shopify Listing Studio | Private Cloudflare Workers + D1 Shopify Admin platform for Ronora draft product creation, 11-metal jewelry pricing, fixed and multi-carat variants, target-net-profit pricing, exact Etsy price comparison, and duplicate-aware SKU lookup. Its private MCP control plane adds field-scoped product and variant-price updates, reversible archive, guarded deletion, single-use approvals, atomic claims, stale-state checks, idempotency, and post-write verification |
